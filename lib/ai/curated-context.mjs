...
//
// No category is excluded here today, but this used to filter out
// movie_news (TMDB, then briefly Trakt, both dropped 2026-08-22 — see git
// history) because TMDB's API Terms of Use barred feeding TMDB content to
// an AI/chatbot application. If a future content source comes with a
// similar restriction, re-add a `.filter(category => !FORBIDDEN.has(...))`
// here rather than threading the exclusion through call sites individually.
export const ALL_CURATED_CATEGORIES = [...FOOTBALL_CATEGORIES, ...NEWS_CATEGORIES, "match_analysis", "match_summary"];
